...
class ProfitLossFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'teacher_shirt_qty' => $this->faker->numberBetween(-100000, 100000),
            ...
            'eat_child_price' => $this->faker->numberBetween(-100000, 100000),
            'eat_prasmanan_price' => $this->faker->numberBetween(-100000, 100000),
            'backup_price' => $this->faker->numberBetween(-100000, 100000),
            'emergency_cost_price' => $this->faker->numberBetween(-100000, 100000),
